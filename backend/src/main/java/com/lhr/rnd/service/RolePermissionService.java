    ...
    private List<RolePermissionConfig> defaultPermissionConfigs() {
        return List.of(
                ...
                new RolePermissionConfig("RND_DIRECTOR", List.of(
                        ...
                        rule("POST", "/api/v1/experiment-forms/*/process-plan/submit", "正式提交工艺", 77),
                        rule("POST", "/api/v1/experiment-forms/*/process-plan/control-points/*/confirm-deviation", "确认极重要工艺偏差", 78),
                        rule("POST", "/api/v1/experiment-forms/*/process-plan/revisions/*/new-draft", "从正式版本创建工艺草稿", 77),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions", "查看工艺正式版本", 76),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*", "查看工艺正式版本详情", 76),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/artifacts", "查看工艺成果文件", 76),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/artifacts/*/download", "下载工艺成果文件", 76),
                        rule("POST", "/api/v1/experiment-forms/*/process-plan/revisions/*/artifacts", "生成工艺成果文件", 77),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/export-check", "查看研发导出检查与预览", 78),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/export-preview", "查看研发导出检查与预览", 78),
                        rule("GET", "/api/v1/experiment-forms/*/trials/*/export-check", "查看研发导出检查与预览", 78),
                        rule("GET", "/api/v1/experiment-forms/*/trials/*/export-preview", "查看研发导出检查与预览", 78),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/export-check", "查看研发导出检查与预览", 78),
                        rule("GET", "/api/v1/experiment-forms/*/trials", "查看试验方案", 76),
                        rule("GET", "/api/v1/experiment-forms/*/trials/*", "查看试验方案详情", 76),
                        rule("POST", "/api/v1/experiment-forms/*/trials", "创建试验方案", 77),
                        rule("PUT", "/api/v1/experiment-forms/*/trials/*", "编辑试验方案", 77),
                        rule("POST", "/api/v1/experiment-forms/*/trials/*/copy", "复制试验方案", 77),
                        rule("POST", "/api/v1/experiment-forms/*/trials/*/archive", "归档或恢复试验方案", 77),
                        rule("POST", "/api/v1/experiment-forms/*/trials/*/submission-preview", "预览试验晋升", 77),
                        rule("POST", "/api/v1/experiment-forms/*/trials/*/submit", "正式提交试验方案", 77),
                        rule("POST", "/api/v1/experiment-forms/*/trials/*/control-points/*/confirm", "确认试验实测", 77),
                        rule("POST", "/api/v1/experiment-forms/*/trials/*/control-points/*/confirm-deviation", "确认试验偏差", 77),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/source", "查看正式版本试验来源", 77),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/displaced-draft", "找回晋升前草稿", 77),
                ...
                new RolePermissionConfig("RND_ENGINEER", List.of(
                        ...
                        rule("POST", "/api/v1/experiment-forms/*/process-plan/submit", "正式提交工艺", 17),
                        rule("POST", "/api/v1/experiment-forms/*/process-plan/revisions/*/new-draft", "从正式版本创建工艺草稿", 17),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions", "查看工艺正式版本", 16),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*", "查看工艺正式版本详情", 16),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/artifacts", "查看工艺成果文件", 16),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/artifacts/*/download", "下载工艺成果文件", 16),
                        rule("POST", "/api/v1/experiment-forms/*/process-plan/revisions/*/artifacts", "生成工艺成果文件", 17),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/export-check", "查看研发导出检查与预览", 78),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/export-preview", "查看研发导出检查与预览", 78),
                        rule("GET", "/api/v1/experiment-forms/*/trials/*/export-check", "查看研发导出检查与预览", 78),
                        rule("GET", "/api/v1/experiment-forms/*/trials/*/export-preview", "查看研发导出检查与预览", 78),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/export-check", "查看研发导出检查与预览", 78),
                        rule("GET", "/api/v1/experiment-forms/*/trials", "查看试验方案", 16),
                        rule("GET", "/api/v1/experiment-forms/*/trials/*", "查看试验方案详情", 16),
                        rule("POST", "/api/v1/experiment-forms/*/trials", "创建试验方案", 17),
                        rule("PUT", "/api/v1/experiment-forms/*/trials/*", "编辑试验方案", 17),
                        rule("POST", "/api/v1/experiment-forms/*/trials/*/copy", "复制试验方案", 17),
                        rule("POST", "/api/v1/experiment-forms/*/trials/*/archive", "归档或恢复试验方案", 17),
                        rule("POST", "/api/v1/experiment-forms/*/trials/*/submission-preview", "预览试验晋升", 17),
                        rule("POST", "/api/v1/experiment-forms/*/trials/*/submit", "正式提交试验方案", 17),
                        rule("POST", "/api/v1/experiment-forms/*/trials/*/control-points/*/confirm", "确认试验实测", 17),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/source", "查看正式版本试验来源", 17),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/displaced-draft", "找回晋升前草稿", 17),
                ...
                new RolePermissionConfig("TESTER", List.of(
                        ...
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/source", "查看正式版本试验来源", 11),
                        rule("GET", "/api/v1/experiment-forms/*/process-plan/revisions/*/artifacts/*/download", "下载工艺成果文件", 11),
